...
<a href="" data-toggle="modal" data-target="#modalExclui<?php echo $dados['cod_categoria'];?>">Excluir</a>  

     </p>
<div class="modal fade" tabindex="-1" role="dialog" id="modalExclui<?php echo $dados['cod_categoria'];?>">
...
<button type="button" value="" id="btnExclui" class="btn btn-primary" onclick="javascript:enviaDados(<?php echo $dados['cod_categoria'];?>+'|'+'excluir','acoes_categoria','retornoExclui','Salvando...');location.href='cadastraCategoria.php';">Sim</button>
